...
if(isset($_SESSION['user'])){
    ...
    include_once '../tareas/borrar.php';
                ...
                <div>
                  <table border="1" id="todos" >
                    ...
                    while($row=mysqli_fetch_array($result)){
                     ?>
                    <form method="POST" action="../operaciones/delete.php">
                     <tr>
                      ...
                      <td><input type="text" onchange="completarPendiente(this)" name="tarea" value="<?php echo $row['descripcion'] ?>" readonly></td>
                      <td> <input type="text" name="estado" value="<?php echo $row['estado'] ?>" readonly> </td>
                      <td><input type="text" onchange="completarPendiente(this)" name="fv" value="<?php echo $row['fechavence'] ?>" readonly></td>
